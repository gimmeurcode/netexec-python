...
Asset root
----------
``netexec-main/assets/`` — one level above this file's ``ui/`` directory.
...
from scripts.engine.constants import C_GREEN_BRIGHT
from .assets import (
    draw_genre_icon,
    draw_star_icon,
    draw_ad_icon,
...
# Asset root: netexec-main/assets/
# __file__ sits at netexec-main/ui/assets_loader.py
#   parents[0] → netexec-main/ui/
#   parents[1] → netexec-main/
